npm install gulp del gulp-install gulp-flatten gulpIf gulp-rename del run-sequence  gulp-composer check-files-exist --save-dev
npm install gulp-sass  gulp-useref  gulp-uglify gulp-minify-css --save-dev
